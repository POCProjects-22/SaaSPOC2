...
namespace GenericRepository.IdentityRepository
{
    ...
    public class IdentityUnitOfWork<TContext> : IIdentityUnitOfWork<TContext>, IDisposable
where TContext : IdentityDbContext, new()
    {
        ...
        public IdentityUnitOfWork(HttpContext httpContext) :this()
        {
        ...
        public IdentityRepository<T,TC> GenericRepository<T,TC>() where T : class where TC : IdentityDbContext,new()
        {
            ...
            {
                var repositoryType = typeof(IdentityRepository<T,TC>);
                var repositoryInstance = Activator.CreateInstance(repositoryType.MakeGenericType(typeof(T)), _context);
                _repositories.Add(type, repositoryInstance);
            }
            return (IdentityRepository<T,TC>)_repositories[type];
        }
    }
}
